...
public class InputTDRCPsgnDtls {


	public  InputTDRCPsgnDtls() {
		testCaseId = '';
		trainNo = '';
		doj = '';
		srcStnCode = '';
	...
	public InputFareDtls getInputFareDtls() {
		return inputFareDtls;
	}


	public void setInputFareDtls(InputFareDtls inputFareDtls) {
		this.inputFareDtls = inputFareDtls;
	}
	...
	private InputFareDtls inputFareDtls;
}
