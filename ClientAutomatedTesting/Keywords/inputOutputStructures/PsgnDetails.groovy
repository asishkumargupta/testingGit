...
public class PsgnDetails {
	...
	public String getPsgnCurrentStatus() {
		return psgnCurrentStatus;
	}
	public void setPsgnCurrentStatus(String psgnCurrentStatus) {
		this.psgnCurrentStatus = psgnCurrentStatus;
	}
	public String getPsgnCurrentDtls() {
		return psgnCurrentDtls;
	}
	public void setPsgnCurrentDtls(String psgnCurrentDtls) {
		this.psgnCurrentDtls = psgnCurrentDtls;
	}
	...
	private String psgnCurrentStatus;
	private String psgnCurrentDtls;
}
