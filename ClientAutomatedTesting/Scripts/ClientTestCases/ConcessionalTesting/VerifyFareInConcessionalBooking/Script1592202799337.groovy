...
import ioStructures.InputTDRCPsgnDtls
	...
	inputTDRCPsgnDtlsList = CustomKeywords.'reusableComponents.CustomKeywords.readInputConcessionalTDRCPsgnDtls'(".\\UserDataFiles\\inputfiles\\ConcessionalBookingDataFiles\\CONCESSIONAL_BOOKING_DATA.csv")
	...
	try {
		...
		partialImageStartName = ".\\UserDataFiles\\outfiles\\ConcessionalBooking\\" + testCaseId + "exceptionImage" + timenow + ".png" ;
